...
EXP_NAME="llama3_8b_fp8_real"
CHECKPOINT_PATH="checkpoints/$EXP_NAME"
WANDB_LOGS_PATH="wandb_logs/$EXP_NAME"
TOKENIZER_ARG="Qwen/Qwen3-8B" # Path to tokenizer model, or "MOCK"
DATA_ARG="processed_data"
...
DATA_CACHE_PATH="/workspace/checkpoints/data_cache_llama3_8b_fp8"
